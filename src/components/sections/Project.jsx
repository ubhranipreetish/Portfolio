        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              A movie app which fetches data from API and displays popular movies and users favorite movies
              </p>
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://movieapp1234.netlify.app/"
            ...
            "
            >
              <h3 className="text-xl font-bold mb-2">Rock Paper Scissor</h3>
              <p className="text-gray-400 mb-4">
              Play a Best of 7 series game of Rock Paper Scissor against Computer.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://ubhranipreetish.github.io/Rock-Paper-Scissor/"
                  className="text-blue-400 hover:text-blue-300 transition-colors my-4"
                >
                  View Project →
                </a>
